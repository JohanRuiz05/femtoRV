...
filepath='/home/sebastian/VLSI/femtoRV/spice/femto/femto_cir.raw'
...
V5=l.get_data('V(SPI_MOSI)')
V6=l.get_data('V(SPI_MOSI_RAM)')

signals = [V1, V2, V3, V4, V5, V6]
sig_names = ["clk", "rst", "spi_miso", "spi_miso_ram", "spi_mosi_ram", "spi_mosi"]
